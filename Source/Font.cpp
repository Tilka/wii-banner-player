...
enum BinaryMagic : u32
{
	...
	BINARY_MAGIC_GLYPH_GROUP = 'GLGR',
	BINARY_MAGIC_FONT_INFORMATION = 'FINF',
	BINARY_MAGIC_TEXTURE_GLYPH = 'TGLP',
	BINARY_MAGIC_CHARACTER_CODE_MAP = 'CMAP',
	BINARY_MAGIC_CHARACTER_WIDTH = 'CWDH'
};
